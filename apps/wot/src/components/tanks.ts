...
export const nodes: TankNode[] = [
  { id: "ms1", name: "MS-1", tier: 1 },
  { id: "bt2", name: "BT-2", tier: 2 },
  { id: "t46", name: "T-46", tier: 3 },
  { id: "bt5", name: "BT-5", tier: 4 },
  { id: "bt7", name: "BT-7", tier: 4 },
  { id: "kv1", name: "KV-1", tier: 5 },
  { id: "kv85", name: "KV-85", tier: 6 },
  { id: "is", name: "IS", tier: 7 },
  { id: "is3", name: "IS-3", tier: 8 },
  // Nhánh chính IS-7
  { id: "t10", name: "T-10", tier: 9 },
  { id: "is7", name: "IS-7", tier: 10 },
  { id: "kr1", name: "KR-1", tier: 11 },
  // Nhánh rẽ Object 277 (từ IS-3)
  { id: "obj257", name: "Obj. 257", tier: 9 },
  { id: "obj277", name: "Obj. 277", tier: 10 },
  // Nhánh rẽ Object 705A (từ IS)
  { id: "ism", name: "IS-M", tier: 8 },
  { id: "obj705", name: "Obj. 705", tier: 9 },
  { id: "obj705a", name: "Obj. 705A", tier: 10 },
  // Nhánh rẽ IS-4 (từ KV-1)
  { id: "t150", name: "T-150", tier: 6 },
  { id: "kv3", name: "KV-3", tier: 7 },
  { id: "kv4", name: "KV-4", tier: 8 },
  { id: "st1", name: "ST-I", tier: 9 },
  { id: "is4", name: "IS-4", tier: 10 },
  // Nhánh rẽ ST-II (từ KV-3)
  { id: "is2ii", name: "IS-2-II", tier: 8 },
  { id: "is3ii", name: "IS-3-II", tier: 9 },
  { id: "stii", name: "ST-II", tier: 10 },
  // Nhánh rẽ Object 140 (từ T-46) - Medium Tank Line
  { id: "t34", name: "T-34", tier: 5 },
  { id: "t3485", name: "T-34-85", tier: 6 },
  { id: "t43", name: "T-43", tier: 7 },
  { id: "t44", name: "T-44", tier: 8 },
  { id: "t54", name: "T-54", tier: 9 },
  { id: "obj140", name: "Obj. 140", tier: 10 },
  // Nhánh rẽ Object 430U (từ T-44)
  { id: "obj430ii", name: "Obj. 430 II", tier: 9 },
  { id: "obj430u", name: "Obj. 430U", tier: 10 },
  { id: "432u", name: "Obj. 432U", tier: 11 },
  // Nhánh rẽ K-91 (từ T-34)
  { id: "a43", name: "A-43", tier: 6 },
  { id: "a44", name: "A-44", tier: 7 },
  { id: "obj416", name: "Obj. 416", tier: 8 },
  { id: "obj430v2", name: "Obj. 430 V.II", tier: 9 },
  { id: "k91", name: "K-91", tier: 10 },
  // Nhánh rẽ T-100 LT (từ BT-7) - Light Tank Line
  { id: "t50", name: "T-50", tier: 5 },
  { id: "mt25", name: "MT-25", tier: 6 },
  { id: "lttb", name: "LTTB", tier: 7 },
  { id: "ltg", name: "LTG", tier: 8 },
  { id: "t54ltwt", name: "T-54 ltwt.", tier: 9 },
  { id: "t100lt", name: "T-100 LT", tier: 10 },
  // Nhánh rẽ Obj. 268 (từ MS-1) - Tank Destroyer Line
  { id: "at1", name: "AT-1", tier: 2 },
  { id: "su76", name: "SU-76", tier: 3 },
  { id: "su85b", name: "SU-85B", tier: 4 },
  { id: "su85", name: "SU-85", tier: 5 },
  { id: "su100", name: "SU-100", tier: 6 },
  { id: "kv2", name: "KV-2", tier: 6 },
  { id: "su152", name: "SU-152", tier: 7 },
  { id: "isu152", name: "ISU-152", tier: 8 },
  { id: "obj704", name: "Obj. 704", tier: 9 },
  { id: "obj268", name: "Obj. 268", tier: 10 },
  // Nhánh Obj. 268 V4 (rẽ lên từ SU-100)
  { id: "su100m1", name: "SU-100M1", tier: 7 },
  { id: "su101", name: "SU-101", tier: 8 },
  { id: "obj263", name: "Obj. 263", tier: 9 },
  { id: "obj268v4", name: "Obj. 268 V4", tier: 10 },
  // Nhánh SPG Obj. 261 (rẽ lên từ SU-85B)
  { id: "su122a", name: "SU-122A", tier: 5 },
  { id: "su8", name: "SU-8", tier: 6 },
  { id: "s51", name: "S-51", tier: 7 },
  { id: "su142", name: "SU-14-2", tier: 8 },
  { id: "212a", name: "212A", tier: 9 },
  { id: "obj261", name: "Obj. 261", tier: 10 },
];
