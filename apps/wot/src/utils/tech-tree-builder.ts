...
/**
 * Build connections array từ tank data
 */
function buildConnections(
  tankData: TankDataMap,
  ...
  Object.entries(tankData).forEach(([tankId, tank]) => {
    if (tank.next_tanks) {
  ...
  Object.entries(tankData).forEach(([tankId, tank]) => {
    ...
    if (tank.next_tanks) {
      Object.entries(tank.next_tanks).forEach(([nextTankId]) => {
        const nextTank = tankData[nextTankId];
...
/**
 * Build nodes array từ tank data
 */
export function buildNodes(
  ...
  return Object.entries(tankData)
    .filter(([tankId, tank]) => {
...
/**
 * Build cả nodes và connections từ tank data
 */
